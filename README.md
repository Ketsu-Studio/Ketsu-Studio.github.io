...
Free privacy policy hosting + website for *App-name*.
...
Ketsu built the *App-name* app as a Free app. This SERVICE is provided by Ketsu at no cost and is intended for use as is.
